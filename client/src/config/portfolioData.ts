...
export const portfolioData = {
  ...
  personal: {
    ...
    tagline:
      "I’m a Software Engineer with experience leading product development teams end-to-end from discovery to delivery.",
  ...
  projects: [
    {
      ...
      description:
        "Modern, responsive portfolio website showcasing projects and experience. Built with React, TypeScript, and Tailwind CSS with dark mode support and smooth animations.",
      technologies: [
        "React",
        "TypeScript",
        "Tailwind CSS",
      ...
      achievement:
        "Designed and developed a clean, performant portfolio with modern UI/UX principles and full mobile responsiveness.",
      liveUrl: "/",
    ...
    },
    {
      ...
      description:
        "API integration platform for hospitality connecting Property Management Systems with third-party services including POS, CRMs, channel managers, and revenue management systems.",
      technologies: [
        "REST APIs",
        "Lightspeed",
        "Toast",
      ...
      achievement:
        "Led data-driven discovery and delivery of 20+ API integrations, driving 10× API adoption and $300K+ ARR growth.",
    ...
    },
    {
      ...
      title: "RoomMaster",
      description:
        "Legacy hospitality Property Management System (PMS) modernization and feature delivery for hotel and hospitality operations.",
      technologies: [
        "Hospitality Tech",
        "PMS",
        "Product Strategy",
      ...
      achievement:
        "Owned product strategy and delivery for legacy PMS platform serving hospitality industry.",
    ...
    },
    {
      ...
      description:
        "The leading marina management platform in the United States, providing comprehensive solutions for marina operations and customer management.",
      technologies: [
        "SaaS",
        "Marina Tech",
        "Product Strategy",
      ...
      achievement:
        "Owned product strategy and end-to-end delivery of payment platform now processing $10M+ annually.",
    ...
    },
    {
      ...
      description:
        "Shared UI component library for mobile app redesigns across Restaurant Brands International's major QSR brands.",
      technologies: [
        "React Native",
        "UI Components",
      ...
      achievement:
        "Coordinated 3 engineering teams, design and QA to deliver reusable component library across major brands.",
    ...
    },
    {
      ...
      description:
        "Automated PowerBI and SQL dashboards for tracking retail product performance across major US and Canada retailers.",
      technologies: ["PowerBI", "SQL", "Data Analytics", "Automation"],
      achievement:
        "Built dashboards and automated reporting workflows, saving 15+ hours per week while delivering insights for 20+ retailers.",
    ...
    },
    {
      ...
      description:
        "National rollout of third-party delivery (UberEats, DoorDash, SkipTheDishes) to 1000+ Tim Hortons locations during COVID-19 response.",
      technologies: ["Program Management", "Delivery Platforms", "Operations"],
      achievement:
        "Managed onboarding for 1000+ stores and coordinated launch of 15+ new SKUs nationwide during pandemic response.",
    ...
    },
    {
      ...
      description:
        "Internal documentation tool and DevOps monitoring dashboard integrating CI/CD pipelines for engineering teams.",
      technologies: ["React", "Node.js", "Angular", "Java", "DevOps"],
      achievement:
        "Built documentation generation tool and monitoring dashboard providing DevOps visibility for internal teams.",
    },
  ],
  ...
  experience: [
    {
      ...
      current: false,
      description:
        "Led product strategy and delivery for multiple B2B SaaS platforms in hospitality and marina management industries.",
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        "Owned shared UI component library delivery for mobile app redesigns across major QSR brands.",
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        "Built data analytics solutions and dashboards for retail product performance tracking.",
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        "Supported national delivery program rollout during COVID-19 response.",
      achievements: [
    ...
    },
    {
      ...
      current: false,
      description:
        "Developed internal tools and DevOps systems for engineering teams.",
      achievements: [
  ...
  contact: {
    ...
    description:
      "I'm always interested in discussing product opportunities, API integrations, or innovative ways to use AI in product development. Feel free to reach out!", // Description text
  },
};
